...
{
    /// <summary>
    /// C/S框架的模块基类，定义了用于模块操作的常用方法。
    /// </summary>
    public class DevBaseControl : ModuleBase
    {
        ...
        public DevBaseControl()
        {
            InitializeComponent();
            //this._Dao = BaseDao.Get();
        }

        public DevBaseControl(string name)
        {
            InitializeComponent();
            this._name = name;
            //this._Dao = BaseDao.Get(name);
        }
