...
(function ($, window, document, undefined)
{
    ...
    _easyform.prototype = {
        ...
        init: function ()
        {
            ...
            //改写 submit 的属性，便于控制
            this.submit_button = this.form.find("input:button");
...
(function ($, window, document, undefined)
{
    ...
    _easyinput.prototype = {
        ...
        judge: {
            ...
            "maxlength": function (ei, v, p)
            {
                var range = p; 
                if (v.length > range)
                    return ei._error("maxlength");
                else
                    return ei._success_rule("maxlength");
