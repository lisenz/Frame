...
namespace Frame.Service.Server.Core
{
    ...
    public class PageAction
    {
        ...
        /// 构造函数，初始化页面方法信息。
        /// </summary>
        /// <param name="methodInfo">被调用的页面方法元数据对象。</param>
        public PageAction(MethodInfo methodInfo)
        {
        ...
        public object Invoke(IPageContext context)
        {
        ...
        /// <param name="context">页面上下文对象，提供调用方法所需的参数等信息。</param>
        /// <returns>返回方法调用执行后的结果。</returns>
        public object Invoke(object instance, IPageContext context)
        {
        ...
        protected virtual object[] ParamsMatch(IPageContext context)
        {
            ...
            foreach (ParameterInfo parameterInfo in paramInfos)
            {
                ...
                try
                {
                    ...
                    else if (paramType.Equals(typeof(IPageContext)))
                    {
