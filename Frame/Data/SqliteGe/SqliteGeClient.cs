...
namespace Frame.Data.SqliteGe
{
    public class SqliteGeClient : DataBase
    {
        ...
        public SqliteGeClient(string connectionString)
        ...
        public virtual void AddParameter(SQLiteCommand command, string name, DbType dbType, int size, ParameterDirection direction, bool nullable, byte precision, byte scale, string sourceColumn, DataRowVersion sourceVersion, object value)
        {
            if (command == null)
        ...
        /// <param name="sourceVersion">在加载参数时使用的DataRowVersion。</param>
        /// <param name="value">参数值。</param>
        public void AddParameter(SQLiteCommand command, string name, DbType dbType, ParameterDirection direction, string sourceColumn, DataRowVersion sourceVersion, object value)
        {
        ...
        /// <param name="dbType">参数数据类型。</param>
        /// <param name="size">参数大小。</param>
        public void AddOutParameter(SQLiteCommand command, string name, DbType dbType, int size)
        {
        ...
        /// <param name="name">参数名称。</param>
        /// <param name="dbType">参数数据类型。</param>
        public void AddInParameter(SQLiteCommand command, string name, DbType dbType)
        {
        ...
        /// <param name="dbType">参数数据类型。</param>
        /// <param name="value">参数值。</param>
        public void AddInParameter(SQLiteCommand command, string name, DbType dbType, object value)
        {
        ...
        /// <param name="sourceColumn">映射到DataSet中的源列名称。</param>
        /// <param name="sourceVersion">在加载参数时使用的DataRowVersion。</param>
        public void AddInParameter(SQLiteCommand command, string name, DbType dbType, string sourceColumn, DataRowVersion sourceVersion)
        {
        ...
        protected new SQLiteParameter CreateParameter(string name, DbType dbType, int size, ParameterDirection direction, bool nullable, byte precision, byte scale, string sourceColumn, DataRowVersion sourceVersion, object value)
        {
            SQLiteParameter param = CreateParameter(name) as SQLiteParameter;
        ...
        /// <param name="value">参数值。</param>
        protected virtual void ConfigureParameter(SQLiteParameter param, string name, DbType dbType, int size, ParameterDirection direction, bool nullable, byte precision, byte scale, string sourceColumn, DataRowVersion sourceVersion, object value)
        {
            param.DbType = dbType;
            param.Size = size;
        ...
        private static SQLiteCommand CreateSqlCommandByCommandType(CommandType commandType, string commandText)
        {
        ...
        {
            ((SQLiteDataAdapter)adapter).RowUpdated += OnSqlRowUpdated;
        }
        ...
        private void OnSqlRowUpdated(object sender, RowUpdatedEventArgs rowThatCouldNotBeWritten)
        {
